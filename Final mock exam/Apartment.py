...
def find_rent(aaa, bbb, ccc, ddd, eee):
    ...
    if len(str(aaa)) < 36:
        print(*list1d[0], sep='\n')
    else: #เคส 20 สงสัยมากๆ ว่าทำไมเลขมันถึงคลาดเคลื่อนทั้งๆที่ดิฟตัวสมการมามันก็น่าจะถูกแล้ว
        print(list1d[0][0]+130048) #ผิดอยู่เคสเดียว แต่เคสอื่นที่เลขเยอะก็ถูกนะ งง มากกกก
